...
_iics_agent_delete()
{
    last_command="iics_agent_delete"
...
_iics_agent_list()
{
    ...
    flags+=("--basic-info")
    local_nonpersistent_flags+=("--basic-info")
    flags+=("--fields=")
    two_word_flags+=("--fields")
    local_nonpersistent_flags+=("--fields")
    local_nonpersistent_flags+=("--fields=")
...
_iics_agent_restart()
{
    last_command="iics_agent_restart"
...
_iics_environment_configs_get()
{
    last_command="iics_environment_configs_get"
...
_iics_environment_configs_set()
{
    last_command="iics_environment_configs_set"
...
_iics_environment_configs()
{
    last_command="iics_environment_configs"
...
_iics_environment_create()
{
    last_command="iics_environment_create"
...
_iics_environment_delete()
{
    last_command="iics_environment_delete"
...
_iics_environment_get()
{
    last_command="iics_environment_get"
...
_iics_environment_list()
{
    last_command="iics_environment_list"
...
_iics_environment_update()
{
    last_command="iics_environment_update"
...
_iics_package_create()
{
    ...
    flags+=("--exclude-found-transitive")
    local_nonpersistent_flags+=("--exclude-found-transitive")
    flags+=("--force")
    flags+=("-f")
    ...
    local_nonpersistent_flags+=("--log-file")
    flags+=("--manifest-file=")
    two_word_flags+=("--manifest-file")
    two_word_flags+=("-m")
    local_nonpersistent_flags+=("--manifest-file")
    local_nonpersistent_flags+=("--manifest-file=")
    ...
    flags+=("--status-target=")
    two_word_flags+=("--status-target")
    local_nonpersistent_flags+=("--status-target")
    local_nonpersistent_flags+=("--status-target=")
    flags+=("--target=")
    two_word_flags+=("--target")
    two_word_flags+=("-t")
...
_iics_release_manifest()
{
    last_command="iics_release_manifest"
    ...
    local_nonpersistent_flags+=("--from-file")
    local_nonpersistent_flags+=("--from-file=")
    flags+=("--include-connections")
    local_nonpersistent_flags+=("--include-connections")
    flags+=("--include-connectors")
    local_nonpersistent_flags+=("--include-connectors")
    flags+=("--mode=")
    two_word_flags+=("--mode")
    ...
    local_nonpersistent_flags+=("--output=")
    flags+=("--output-root=")
    two_word_flags+=("--output-root")
    local_nonpersistent_flags+=("--output-root")
    local_nonpersistent_flags+=("--output-root=")
    flags+=("--source=")
    two_word_flags+=("--source")
    local_nonpersistent_flags+=("--source")
    ...
    local_nonpersistent_flags+=("--targets=")
    flags+=("--valid-targets=")
    two_word_flags+=("--valid-targets")
    local_nonpersistent_flags+=("--valid-targets")
    local_nonpersistent_flags+=("--valid-targets=")
    flags+=("--config=")
    two_word_flags+=("--config")
    flags+=("--debug")
...
_iics_release_plan()
{
    last_command="iics_release_plan"
    ...
    local_nonpersistent_flags+=("--full-package-config=")
    flags+=("--include-found-transitive")
    local_nonpersistent_flags+=("--include-found-transitive")
    flags+=("--log-file")
    local_nonpersistent_flags+=("--log-file")
    flags+=("--manifest=")
    ...
    local_nonpersistent_flags+=("--output-root")
    local_nonpersistent_flags+=("--output-root=")
    flags+=("--package-fields=")
    two_word_flags+=("--package-fields")
    local_nonpersistent_flags+=("--package-fields")
    local_nonpersistent_flags+=("--package-fields=")
    flags+=("--publish-exclude-file=")
    two_word_flags+=("--publish-exclude-file")
    local_nonpersistent_flags+=("--publish-exclude-file")
    local_nonpersistent_flags+=("--publish-exclude-file=")
    flags+=("--publish-exclude-regex=")
    two_word_flags+=("--publish-exclude-regex")
    local_nonpersistent_flags+=("--publish-exclude-regex")
    local_nonpersistent_flags+=("--publish-exclude-regex=")
    flags+=("--publish-fields=")
    two_word_flags+=("--publish-fields")
    local_nonpersistent_flags+=("--publish-fields")
    local_nonpersistent_flags+=("--publish-fields=")
    flags+=("--publish-include-found-transitive")
    local_nonpersistent_flags+=("--publish-include-found-transitive")
    flags+=("--target-profile-map=")
    two_word_flags+=("--target-profile-map")
    local_nonpersistent_flags+=("--target-profile-map")
    local_nonpersistent_flags+=("--target-profile-map=")
    flags+=("--valid-targets=")
    two_word_flags+=("--valid-targets")
    local_nonpersistent_flags+=("--valid-targets")
...
_iics_release_validate()
{
    last_command="iics_release_validate"
...
_iics_root_command()
{
    ...
    if [[ -z "${BASH_VERSION:-}" || "${BASH_VERSINFO[0]:-}" -gt 3 ]]; then
        ...
        command_aliases+=("rt")
        aliashash["rt"]="environment"
        command_aliases+=("runtime")
        aliashash["runtime"]="environment"
    fi
    commands+=("export")
    commands+=("folder")
    commands+=("group")

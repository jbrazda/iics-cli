...
var agentColumnMap = map[string]output.Column{
	...
	"orgId":            {Header: "ORG ID", Field: "orgId", Width: 12, Priority: 5, Shrink: output.ShrinkNever},
	"name":             {Header: "NAME", Field: "name", Width: 22, Priority: 1},
	"description":      {Header: "DESCRIPTION", Field: "description", Width: 30, Priority: 4, Shrink: output.ShrinkWrap},
	"agentHost":        {Header: "HOST", Field: "agentHost", Width: 20, Priority: 2, Shrink: output.ShrinkTruncate},
	"active":           {Header: "ACTIVE", Field: "active", Width: 7, Priority: 2, Shrink: output.ShrinkNever, Func: agentActiveFunc},
	"readyToRun":       {Header: "READY", Field: "readyToRun", Width: 7, Priority: 2, Shrink: output.ShrinkNever, Func: agentReadyFunc},
	"platform":         {Header: "PLATFORM", Field: "platform", Width: 9, Priority: 2, Shrink: output.ShrinkNever},
	"agentVersion":     {Header: "VERSION", Field: "agentVersion", Width: 9, Priority: 2, Shrink: output.ShrinkNever},
	"upgradeStatus":    {Header: "UPGRADE", Field: "upgradeStatus", Width: 13, Priority: 3, Shrink: output.ShrinkTruncate},
	"agentGroupId":     {Header: "GROUP ID", Field: "agentGroupId", Width: 24, Priority: 5, Shrink: output.ShrinkNever},
	"federatedId":      {Header: "FEDERATED ID", Field: "federatedId", Width: 24, Priority: 5, Shrink: output.ShrinkNever},
	"serverUrl":        {Header: "SERVER URL", Field: "serverUrl", Width: 30, Priority: 3, Shrink: output.ShrinkTruncateLeft},
	"spiUrl":           {Header: "SPI URL", Field: "spiUrl", Width: 30, Priority: 3, Shrink: output.ShrinkTruncateLeft},
	"proxyHost":        {Header: "PROXY HOST", Field: "proxyHost", Width: 18, Priority: 3, Shrink: output.ShrinkTruncate},
	"createdBy":        {Header: "CREATED BY", Field: "createdBy", Width: 18, Priority: 3, Shrink: output.ShrinkTruncate},
	"updatedBy":        {Header: "UPDATED BY", Field: "updatedBy", Width: 18, Priority: 3, Shrink: output.ShrinkTruncate},
	"createTime":       {Header: "CREATED", Field: "createTime", Width: 22, Priority: 2, Shrink: output.ShrinkNever},
	"updateTime":       {Header: "UPDATED", Field: "updateTime", Width: 22, Priority: 2, Shrink: output.ShrinkNever},
	"lastStatusChange": {Header: "LAST STATUS CHANGE", Field: "lastStatusChange", Width: 22, Priority: 3, Shrink: output.ShrinkNever},
	"lastUpgraded":     {Header: "LAST UPGRADED", Field: "lastUpgraded", Width: 22, Priority: 3, Shrink: output.ShrinkNever},
	"lastUpgradeCheck": {Header: "LAST UPGRADE CHECK", Field: "lastUpgradeCheck", Width: 22, Priority: 3, Shrink: output.ShrinkNever},
	"configUpdateTime": {Header: "CONFIG UPDATED", Field: "configUpdateTime", Width: 22, Priority: 3, Shrink: output.ShrinkNever},
	"createTimeUTC":    {Header: "CREATED (UTC)", Field: "createTimeUTC", Width: 22, Priority: 3, Shrink: output.ShrinkNever},
	"updateTimeUTC":    {Header: "UPDATED (UTC)", Field: "updateTimeUTC", Width: 22, Priority: 3, Shrink: output.ShrinkNever},
}

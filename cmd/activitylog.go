...
var activityLogColumnMap = map[string]output.Column{
	"id":                   {Header: "ID", Field: "id", Width: 20, Priority: 5, Shrink: output.ShrinkNever},
	"objectName":           {Header: "NAME", Field: "objectName", Width: 30, Priority: 1},
	"type":                 {Header: "TYPE", Field: "type", Width: 10, Priority: 2, Shrink: output.ShrinkNever},
	"state":                {Header: "STATE", Field: "state", Width: 12, Priority: 1, Func: activityLogStateLabel},
	"runId":                {Header: "RUN ID", Field: "runId", Width: 12, Priority: 3, Shrink: output.ShrinkTruncate},
	"objectId":             {Header: "TASK ID", Field: "objectId", Width: 24, Priority: 5, Shrink: output.ShrinkNever},
	"agentId":              {Header: "AGENT ID", Field: "agentId", Width: 24, Priority: 5, Shrink: output.ShrinkNever},
	"runtimeEnvironmentId": {Header: "RUNTIME ENV", Field: "runtimeEnvironmentId", Width: 24, Priority: 5, Shrink: output.ShrinkNever},
	"startTime":            {Header: "START TIME (ET)", Field: "startTime", Width: 22, Priority: 2, Shrink: output.ShrinkNever},
	"endTime":              {Header: "END TIME (ET)", Field: "endTime", Width: 22, Priority: 2, Shrink: output.ShrinkNever},
	"startTimeUtc":         {Header: "START TIME", Field: "startTimeUtc", Width: 22, Priority: 1},
	"endTimeUtc":           {Header: "END TIME", Field: "endTimeUtc", Width: 22, Priority: 1},
	"failedSourceRows":     {Header: "FAILED SRC", Field: "failedSourceRows", Width: 12, Priority: 2, Shrink: output.ShrinkNever},
	"successSourceRows":    {Header: "SUCCESS SRC", Field: "successSourceRows", Width: 12, Priority: 2, Shrink: output.ShrinkNever},
	"failedTargetRows":     {Header: "FAILED TGT", Field: "failedTargetRows", Width: 12, Priority: 2, Shrink: output.ShrinkNever},
	"successTargetRows":    {Header: "SUCCESS TGT", Field: "successTargetRows", Width: 12, Priority: 2, Shrink: output.ShrinkNever},
	"scheduleName":         {Header: "SCHEDULE", Field: "scheduleName", Width: 20, Priority: 3, Shrink: output.ShrinkTruncate},
	"errorMsg":             {Header: "ERROR", Field: "errorMsg", Width: 40, Priority: 4, Shrink: output.ShrinkWrap},
	"startedBy":            {Header: "STARTED BY", Field: "startedBy", Width: 20, Priority: 3, Shrink: output.ShrinkTruncate},
	"runContextType":       {Header: "RUN CONTEXT", Field: "runContextType", Width: 15, Priority: 3, Shrink: output.ShrinkTruncate},
	"isStopped":            {Header: "STOPPED", Field: "isStopped", Width: 8, Priority: 2, Shrink: output.ShrinkNever},
	"totalSuccessRows":     {Header: "TOTAL SUCCESS", Field: "totalSuccessRows", Width: 14, Priority: 2, Shrink: output.ShrinkNever},
	"totalFailedRows":      {Header: "TOTAL FAILED", Field: "totalFailedRows", Width: 13, Priority: 2, Shrink: output.ShrinkNever},
	"stopOnError":          {Header: "STOP ON ERR", Field: "stopOnError", Width: 12, Priority: 2, Shrink: output.ShrinkNever},
	"contextExternalId":    {Header: "CONTEXT ID", Field: "contextExternalId", Width: 24, Priority: 5, Shrink: output.ShrinkNever},
}

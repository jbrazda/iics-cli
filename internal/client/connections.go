...
func (c *Client) ListConnections(ctx context.Context, opts ConnectionListOptions) ([]Connection, error) {
	...
	var resp []Connection
	if err := c.doJSONWithQuery(ctx, http.MethodGet, fmt.Sprintf("%s/connections", BaseAPIPathV3), query, nil, &resp); err != nil {
		return nil, err
	}
	return resp, nil
}
...
func (c *Client) GetConnection(ctx context.Context, id string) (*Connection, error) {
	var resp Connection
	if err := c.doJSON(ctx, http.MethodGet, fmt.Sprintf("%s/connections/%s", BaseAPIPathV3, id), nil, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (c *Client) CreateConnection(ctx context.Context, conn *Connection) (*Connection, error) {
	var resp Connection
	if err := c.doJSON(ctx, http.MethodPost, fmt.Sprintf("%s/connections", BaseAPIPathV3), conn, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (c *Client) UpdateConnection(ctx context.Context, id string, conn *Connection) (*Connection, error) {
	var resp Connection
	if err := c.doJSON(ctx, http.MethodPut, fmt.Sprintf("%s/connections/%s", BaseAPIPathV3, id), conn, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (c *Client) DeleteConnection(ctx context.Context, id string) error {
	return c.doJSON(ctx, http.MethodDelete, fmt.Sprintf("%s/connections/%s", BaseAPIPathV3, id), nil, nil)
}

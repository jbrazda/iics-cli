...
func (c *Client) ListRuntimeEnvironments(ctx context.Context, opts RuntimeListOptions) ([]RuntimeEnvironment, error) {
	...
	if err := c.doJSONWithQuery(ctx, http.MethodGet, "runtimeEnvironments", query, nil, &resp); err != nil {
		return nil, err
	}
	return resp, nil
}
...
func (c *Client) GetRuntimeEnvironment(ctx context.Context, id string) (*RuntimeEnvironment, error) {
	var resp RuntimeEnvironment
	if err := c.doJSON(ctx, http.MethodGet, fmt.Sprintf("runtimeEnvironments/%s", id), nil, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (c *Client) CreateRuntimeEnvironment(ctx context.Context, rt *RuntimeEnvironment) (*RuntimeEnvironment, error) {
	var resp RuntimeEnvironment
	if err := c.doJSON(ctx, http.MethodPost, "runtimeEnvironments", rt, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (c *Client) UpdateRuntimeEnvironment(ctx context.Context, id string, rt *RuntimeEnvironment) (*RuntimeEnvironment, error) {
	var resp RuntimeEnvironment
	if err := c.doJSON(ctx, http.MethodPut, fmt.Sprintf("runtimeEnvironments/%s", id), rt, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}

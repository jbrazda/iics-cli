...
func (c *Client) ListUserGroups(ctx context.Context, opts UserGroupListOptions) ([]UserGroup, error) {
	...
	var resp []UserGroup
	if err := c.doJSONWithQuery(ctx, http.MethodGet, "userGroups", query, nil, &resp); err != nil {
		return nil, err
	}
	return resp, nil
}
...
func (c *Client) GetUserGroup(ctx context.Context, id string) (*UserGroup, error) {
	var resp UserGroup
	if err := c.doJSON(ctx, http.MethodGet, fmt.Sprintf("userGroups/%s", id), nil, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (c *Client) CreateUserGroup(ctx context.Context, group *UserGroup) (*UserGroup, error) {
	var resp UserGroup
	if err := c.doJSON(ctx, http.MethodPost, "userGroups", group, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (c *Client) UpdateUserGroup(ctx context.Context, id string, group *UserGroup) (*UserGroup, error) {
	var resp UserGroup
	if err := c.doJSON(ctx, http.MethodPut, fmt.Sprintf("userGroups/%s", id), group, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (c *Client) DeleteUserGroup(ctx context.Context, id string) error {
	return c.doJSON(ctx, http.MethodDelete, fmt.Sprintf("userGroups/%s", id), nil, nil)
}

...
func (c *Client) ListSchedules(ctx context.Context, opts ScheduleListOptions) ([]Schedule, error) {
	...
	var resp []Schedule
	if err := c.doJSONWithQuery(ctx, http.MethodGet, "schedule", query, nil, &resp); err != nil {
		return nil, err
	}
	return resp, nil
}
...
func (c *Client) GetSchedule(ctx context.Context, id string) (*Schedule, error) {
	var resp Schedule
	if err := c.doJSON(ctx, http.MethodGet, fmt.Sprintf("schedule/%s", id), nil, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (c *Client) CreateSchedule(ctx context.Context, schedule *Schedule) (*Schedule, error) {
	var resp Schedule
	if err := c.doJSON(ctx, http.MethodPost, "schedule", schedule, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (c *Client) UpdateSchedule(ctx context.Context, id string, schedule *Schedule) (*Schedule, error) {
	var resp Schedule
	if err := c.doJSON(ctx, http.MethodPut, fmt.Sprintf("schedule/%s", id), schedule, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (c *Client) DeleteSchedule(ctx context.Context, id string) error {
	return c.doJSON(ctx, http.MethodDelete, fmt.Sprintf("schedule/%s", id), nil, nil)
}

...
func (c *Client) Checkout(ctx context.Context, objectID string) (*SourceControlResult, error) {
	...
	if err := c.doJSON(ctx, http.MethodPost, BaseAPIPathV3+"/sourceControl/checkout", body, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (c *Client) Checkin(ctx context.Context, objectID, comment string) (*SourceControlResult, error) {
	...
	var resp SourceControlResult
	if err := c.doJSON(ctx, http.MethodPost, BaseAPIPathV3+"/sourceControl/checkin", body, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (c *Client) Pull(ctx context.Context) (*SourceControlResult, error) {
	var resp SourceControlResult
	if err := c.doJSON(ctx, http.MethodPost, BaseAPIPathV3+"/sourceControl/pull", nil, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (c *Client) Commit(ctx context.Context, comment string) (*SourceControlResult, error) {
	...
	var resp SourceControlResult
	if err := c.doJSON(ctx, http.MethodPost, BaseAPIPathV3+"/sourceControl/commit", body, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (c *Client) GetSourceControlStatus(ctx context.Context, objectID string) (*SourceControlResult, error) {
	var resp SourceControlResult
	if err := c.doJSON(ctx, http.MethodGet, fmt.Sprintf("%s/sourceControl/%s", BaseAPIPathV3, objectID), nil, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
